...
function renderCloseTableContent(){
  ...
  if(d.length===0){
    ...
    for(var i=0;i<d.length;i++){
      ...
      h+="<div style='font-size:14px;color:#e8d8a0;font-weight:600;margin-bottom:8px'>"+p.name+(p.country?" "+countryFlag(p.country):"")+"</div>";
